...
<body>
    ...
    <div class="main-content">
        <h1>Teachers List</h1>
        <a href="#" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addTeacherModal">Add New Teacher</a>
                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a href="#" class="btn btn-warning edit-teacher" data-id="<?php echo $row['id']; ?>" data-bs-toggle="modal" data-bs-target="#editTeacherModal">Edit</a>
